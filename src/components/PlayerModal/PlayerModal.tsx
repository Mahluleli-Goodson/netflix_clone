            ...
            <div className="min-h-[500px] max-w-[900px] w-full mx-5 bg-black rounded-md overflow-hidden">
                ...
                <div className="flex py-5 mx-5 border-b-[0.001em] border-gray-900">
                    <div className="flex items-center">
                        ...
                        <ThumbUpIcon className="w-10 h-10 mx-1 border-2 border-gray-500 p-1 pl-2 rounded-full cursor-pointer"/>
                        <ThumbDownIcon className="w-10 h-10 mx-1 border-2 border-gray-500 p-1 pr-2 rounded-full cursor-pointer"/>
                    </div>
                </div>
                ...
                <div className="flex p-5 justify-between">
                    <div className="max-w-xl">
                        ...
                        <p className="text-[1rem] font-light text-justify">{overview}</p>
                    ...
                    <div className="flex flex-grow justify-center items-center">
                        {
                            poster_path
                            &&
                            <img className="w-32 rounded-md shadow-[0 0 13px #fff]" src={cover} alt={title}/>
                        }
                    </div>
                </div>
                ...
                <div className="w-full mb-10 px-5">
                    <MoviesTrail carousel movieList={recommended} coverOrientation={"landscape"} chevronBlend={"from-black"}/>
                </div>
            </div>
        </Modal>
    );
